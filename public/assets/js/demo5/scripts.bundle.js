...
var KTLayout = function() {
    ...
    var initHeaderMenu = function() {
        ...
        headerMenuOffcanvas2 = new KTOffcanvas('kt_header_menu_wrapper2', {
            overlay: true,
            baseClass: 'kt-header-menu-wrapper',
            closeBy: 'kt_header_menu_mobile_close_btn2',
            toggleBy: {
                target: 'kt_header_mobile_toggler2',
                state: 'kt-header-mobile__toolbar-toggler--active'
            }
        });

        headerMenu2 = new KTMenu('kt_header_menu2', {
            submenu: {
                desktop: 'dropdown',
                tablet: 'accordion',
                mobile: 'accordion'
