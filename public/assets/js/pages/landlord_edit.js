jQuery(document).ready(function() {
    ...
    for (var i=0; i < documentIndex; i++){
        rules2['document['+i+'][type]'] = {
            required: true
        };
        rules2['document['+i+'][document]'] = {
            required: true
        };
    }
    var rules3 = {};
    ...
    for (var i=0; i < contactIndex; i++){
        rules3['contact['+i+'][type]'] = {
            required: true
        };
        rules3['contact['+i+'][firstName]'] = {
            required: true
        };
        rules3['contact['+i+'][lastName]'] = {
            required: true
        };
        rules3['contact['+i+'][company]'] = {
            required: true
        };
        rules3['contact['+i+'][email]'] = {
            required: true,
            email: true
        };
        rules3['contact['+i+'][mobile]'] = {
            required: true
        };
